package com.ruoyi.chineseSub.controller;
...
import com.ruoyi.chineseSub.service.ITestChineseSubService;
 ...
 */
@RestController
@RequestMapping("/chineseSub/chineseSub")
public class TestChineseSubController extends BaseController
{
     ...
     * 查询主观题列表
     */
    @PreAuthorize("@ss.hasPermi('chineseSub:chineseSub:list')")
    @GetMapping("/list")
     ...
     * 导出主观题列表
     */
    @PreAuthorize("@ss.hasPermi('chineseSub:chineseSub:export')")
     ...
     * 获取主观题详细信息
     */
    @PreAuthorize("@ss.hasPermi('chineseSub:chineseSub:query')")
     ...
     * 新增主观题
     */
    @PreAuthorize("@ss.hasPermi('chineseSub:chineseSub:add')")
     ...
     * 修改主观题
     */
    @PreAuthorize("@ss.hasPermi('chineseSub:chineseSub:edit')")
     ...
     * 删除主观题
     */
    @PreAuthorize("@ss.hasPermi('chineseSub:chineseSub:remove')")
